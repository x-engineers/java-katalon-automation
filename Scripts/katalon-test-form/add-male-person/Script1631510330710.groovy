...
WebUI.check(findTestObject('katalon-test-form/form-label/label_Male'))
...
WebUI.check(findTestObject('katalon-test-form/form-label/label_Read books'))

WebUI.check(findTestObject('katalon-test-form/form-label/label_Via discovery and experiment'))

WebUI.check(findTestObject('katalon-test-form/form-label/label_Contribute to opensource projects'))
